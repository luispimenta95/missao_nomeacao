<div id="depoimentos" class="text-center">
    <h2 class="text-2xl font-bold text-primary" data-aos="fade-up">Depoimentos</h2>
    <p class="mt-2 text-gray-600 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">Histórias reais de quem transformou resultados com o programa.</p>
        ...
        <div class="space-y-4">
            <div data-slice class="max-w-3xl mx-auto bg-white p-6 rounded-2xl card-shadow" data-aos="fade-up">
                <div class="flex items-start gap-4">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-sm text-gray-600 mt-1">"Consegui o meu objetivo em menos de 6 meses. Método prático e suporte constante."</p>
                    </div>
                </div>
            </div>
            ...
            <div data-slice class="hidden max-w-3xl mx-auto bg-white p-6 rounded-2xl card-shadow" data-aos="fade-up">
                <div class="flex items-start gap-4">
                    ...
                    <div class="text-left">
                        <p class="font-semibold">Carla R.</p>
                        <p class="text-sm text-gray-600 mt-1">"Simulados que realmente prepararam para o dia da prova. Recomendo!"</p>
                    </div>
                </div>
            </div>
        </div>
