        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                @if(isset($materials) && $materials->count())
                    @foreach($materials as $material)
                        <article class="p-6 rounded-2xl card-shadow hover:scale-105 transition transform bg-gray-900 text-white border border-yellow-600" data-id="{{ $material->id }}" data-aos="zoom-in">
                    ...
                    @endforeach
                @else
                    <div class="col-span-1 sm:col-span-3 p-6 rounded-2xl card-shadow bg-gray-900 text-white text-center border border-yellow-600">
