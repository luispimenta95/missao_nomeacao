        ...
        <div class="max-w-4xl mx-auto space-y-3">
            <div class="bg-site rounded-2xl card-shadow overflow-hidden border border-yellow-600">
                ...
                <div id="faq-1" class="px-6 pb-6 hidden">
                    <p class="text-white leading-relaxed">A mentoria foi criada justamente para eliminar os erros que mantêm bons alunos travados. Aqui, você vai ter acompanhamento real, com ajustes e correções ao longo do processo. É impossível ficar no mesmo lugar quando se tem direção.</p>
                </div>
            </div>
            ...
            <div class="bg-site rounded-2xl card-shadow overflow-hidden border border-yellow-600">
                ...
                <div id="faq-3" class="px-6 pb-6 hidden">
                    <p class="text-white leading-relaxed">Eu também duvidei de mim mesma muitas vezes. E foi por isso que criei uma mentoria que ensina constância antes de ensinar conteúdo. Você não precisa começar com disciplina perfeita…precisa começar com direção. A constância vem quando o método certo elimina a confusão.</p>
                </div>
            </div>
            ...
            <div class="bg-site rounded-2xl card-shadow overflow-hidden border border-yellow-600">
                ...
                <div id="faq-4" class="px-6 pb-6 hidden">
                    <p class="text-white leading-relaxed">Todos nós já sentimos isso. Mas na Missão Nomeação você não vai caminhar sozinho. A mentoria foi feita pra reconstruir confiança e mostrar que errar faz parte do processo. Aqui, cada tentativa é analisada, corrigida e transformada em aprendizado real.</p>
                </div>
            </div>
