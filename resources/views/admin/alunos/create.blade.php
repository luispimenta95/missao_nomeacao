        ...
        <form action="{{ route('alunos.store') }}" method="POST" class="bg-white p-8 rounded shadow-lg max-w-2xl">
            ...
            <div class="mb-6">
                <label class="block">
                    ...
                    <input type="text" name="nome" required class="mt-2 w-full rounded border border-gray-300 p-3 focus:ring-primary focus:border-primary @error('nome') border-red-500 @enderror" value="{{ old('nome') }}" placeholder="Nome completo">
